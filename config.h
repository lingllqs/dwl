...
#define COLOR(hex)    { ((hex >> 24) & 0xFF) / 255.0f, \
                        ...
                        (hex & 0xFF) / 255.0f }
/* 外观 */
static const int sloppyfocus               = 1;  /* 聚焦跟随鼠标指针位置 */
...
static const MonitorRule monrules[] = {
	...
	*/
	{ NULL,       0.55f, 1,      1,    &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,   -1,  -1 }, /* 默认布局 */
};
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_q,          killclient,     {0} }, // 关闭窗口
	{ MODKEY,                    XKB_KEY_Return,     spawn,          {.v = termcmd} },// 启动终端
	...
	/*{ MODKEY,                    XKB_KEY_t,          setlayout,      {.v = &layouts[0]} }, // 瓷砖布局*/
	/*{ MODKEY,                    XKB_KEY_f,          setlayout,      {.v = &layouts[1]} }, // 浮动布局*/
	/*{ MODKEY,                    XKB_KEY_m,          setlayout,      {.v = &layouts[2]} }, // 单窗口布局*/
	...
	TAGKEYS(          XKB_KEY_1, XKB_KEY_exclam,                     0), // mod + 1 --> tag1
